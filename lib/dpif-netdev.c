 ...
 * the corresponding 16-bit flow_table index to the 'dp_netdev_flow'. Each flow
 * thus occupies 32bit which is much more memory efficient than EMC. SMC uses
 * a set-associative design that each bucket contains SMC_ENTRY_PER_BUCKET
 * number of entries.
 *
 *
 * Thread-safety
